...
const productsFragments = document.createDocumentFragment()
allProducts.forEach(function(product){
    ...
    productsFragments.appendChild(shopItemContainer)
})
shopItemsContainer.appendChild(productsFragments)
...
const basketProductsFragment = document.createDocumentFragment()
function basketProductsGenerator(userBasketArray){
    ...
    userBasketArray.forEach(function (basketItem){
        ...
        basketProductContainer.className = "cart-row"
        basketProductContainer.insertAdjacentHTML("beforeend",
            `
        ...
        basketProductsFragment.appendChild(basketProductContainer)
    })
    basketProductsContainer.appendChild(basketProductsFragment)
}
