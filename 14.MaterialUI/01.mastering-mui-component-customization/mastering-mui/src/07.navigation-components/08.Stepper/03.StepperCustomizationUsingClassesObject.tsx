...
import {
    ...
    Button, Typography, StepConnector, MobileStepper, stepClasses,
    stepConnectorClasses, mobileStepperClasses
} from "@mui/material";
...
export default function StepperCustomizationUsingClassesObject() {
    ...
    const CustomConnector = <StepConnector sx={{ [`& > .${stepConnectorClasses.line}`]: { ...connectorStyles, ...connectorHeightStyle } }} />
