import { Button, Menu, MenuItem, menuItemClasses, typographyClasses, Avatar, Zoom, Typography } from '@mui/material'
import React, { useState } from 'react'
import { Apple as AppleIcon } from '@mui/icons-material'

export default function MenuCustomizationUsingClassesObject() {
                ...
                slotProps={{
                    paper: {
                        sx: {
                            ...
                            [`& .${menuItemClasses.root}, & .${typographyClasses.root}`]: {
                                color: "white",
                                fontFamily: "Verdana",
                                fontSize: "1.5rem",
                                borderColor: "#fff",
