import { Pagination, PaginationItem, paginationItemClasses } from "@mui/material";
import { useState } from "react";

import { ArrowBack, ArrowForward, ArrowUpward, ArrowDownward } from "@mui/icons-material";

export default function PaginationCustomizationUsingClassesObject() {
        ...
        <div>
            ...
            <Pagination
                ...
                sx={{
                    ...
                    [`& .${paginationItemClasses.firstLast}`]: {
                        bgcolor: "purple",
                        borderColor: "#000",
                        borderWidth: 2,
                        color: "#fff",
